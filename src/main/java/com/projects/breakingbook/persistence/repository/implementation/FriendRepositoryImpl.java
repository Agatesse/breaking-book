...
public class FriendRepositoryImpl implements FriendRepository {
    ...
    private static final String INSERT = "INSERT INTO friend(friend_name, friend_avatar, friend_breaking_book_user) VALUES (?, ?, ?)";
    private static final String SELECT_ALL = "SELECT * FROM friend INNER JOIN breaking_book_user r ON friend.friend_breaking_book_user = r.breaking_book_user_id WHERE friend.friend_breaking_book_user = ?;";
    private static final String SELECT_BY_ID = "SELECT * FROM friend INNER JOIN breaking_book_user r ON friend.friend_breaking_book_user = r.breaking_book_user_id " +
            "WHERE friend_id = ?";
    private static final String DELETE_BY_ID = "DELETE FROM friend WHERE friend_id = ?";
    private static final String DELETE_ALL = "DELETE FROM friend";
    private static final String UPDATE = "UPDATE friend SET friend_name = ?, friend_avatar = ?, friend_breaking_book_user = ? WHERE " +
            "friend_id = ?";

    private static final String SELECT_JOIN = "SELECT * FROM friend " +
    ...
    private static final String SELECT_JOIN_BY_ID = "SELECT * FROM friend " +
            "INNER JOIN book_friend ON friend.friend_id = book_friend.book_friend_friend_id " +
            "INNER JOIN book ON book.book_id = book_friend.book_friend_book_id " +
            "INNER JOIN breaking_book_user r ON book.book_breaking_book_user = r.breaking_book_user_id " +
    ...
    private static final String INSERT_BOOK_TO_HISTORY = "INSERT INTO book_friend(book_friend_book_id, book_friend_friend_id) VALUES (?, ?)";
