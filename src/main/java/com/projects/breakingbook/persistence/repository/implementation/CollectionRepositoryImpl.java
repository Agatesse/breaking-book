...
public class CollectionRepositoryImpl implements CollectionRepository {
    ...
    private static final String INSERT = "INSERT INTO collection(collection_name, collection_breaking_book_user) VALUES (?, ?)";
    private static final String SELECT_ALL = "SELECT * FROM collection INNER JOIN breaking_book_user r ON " +
            "collection.collection_breaking_book_user = r.breaking_book_user_id WHERE collection_breaking_book_user = ?";
    private static final String SELECT_BY_ID = "SELECT * FROM collection INNER JOIN breaking_book_user r ON " +
    ...
    private static final String SELECT_JOIN = "SELECT * FROM collection " +
    ...
    private static final String SELECT_JOIN_BY_ID = "SELECT * FROM collection " +
    ...
    private static final String INSERT_BOOK_IN_COLLECTION = "INSERT INTO book_collection(book_collection_book_id, book_collection_collection_id) VALUES (?, ?);";
    private static final String REMOVE_BOOK_FROM_COLLECTION = "DELETE FROM book_collection WHERE book_collection_book_id = ? AND book_collection_collection_id = ?;";
